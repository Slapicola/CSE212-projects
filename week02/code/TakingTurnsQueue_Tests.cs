...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The AddPerson function was adding people to the front of the list instead of the back.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The GetNextPerson function was not accounting for people that start with 0 turns
    ...
    // Defect(s) Found: the GetNextPerson function was not accountiiing for negative turns.
